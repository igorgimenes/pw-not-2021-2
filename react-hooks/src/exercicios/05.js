...
function Tilt({children}) {
  ...
  React.useEffect(() => {
    ...
    // quando o useeffect() retorna uma função, esta será executada na fase
    // de finalização (unmount) do componente
  ...
  }, []) // => quando o vetor de dependencias do use effect() fica vazio
         // ele é executado apenas um vez, na primeira atualização do 
         // componente, durante o carregamento da página
