...
function PokemonInfo({pokemonName}) {
  ...
  */
  ...
  // Criando variáveis avulsas somente-leitura para facilitar o trabalho
  // com variável de estado objeto (usando desestruturação)
  ...
  //   )
    fetchPokemon(pokemonName).then( // deu certo
      pokemonData => {
        ...
        /// let stateTemp = {...state} // copia obj state
      ...
      error => {
        /// setError(error)
        /// setStatus('rejected') // requisição foi rejeitada
